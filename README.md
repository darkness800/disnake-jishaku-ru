...
[![License](https://img.shields.io/pypi/l/jishaku.svg)](https://github.com/Disnake-Extensions/jishaku/blob/master/LICENSE)
...
[![Issues](https://img.shields.io/github/issues/Gorialis/jishaku.svg?colorB=3333ff)](https://github.com/Disnake-Extensions/jishaku/issues)
...
>
> However, if you personally decide that you wish to use a fork, I will allow Jishaku to honor your decision by removing the `discord` package requirement. **This means, from now on, installing jishaku will not automatically handle installing `discord`, you must choose a version to use yourself**. Any fork that you use must be compatible with the original (in that it supplies the `discord` module and its namespaces).
>
...
> ```bash
> pip install -U git+https://github.com/Disnake-Extensions/jishaku
> ```
...
> From GitHub:
> ```bash
> pip install -U "jishaku @ git+https://github.com/Disnake-Extensions/jishaku@master"
> ```
> From GitLab:
> ```bash
...
> From GitHub:
> ```bash
> pip install -U --force-reinstall "jishaku @ git+https://github.com/Disnake-Extensions/jishaku@master"
> ```
> From GitLab:
> ```bash
